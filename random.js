...
async function showRandomImage() {
    ...
    try {
        ...
        document.getElementById('intro').innerHTML = `<p class="desc-text">Welcome to the Random Art Slideshow v0.1 <br />Data courtesy of the <a href="https://api.artic.edu/docs/#introduction">Chicago Art Institute</a>.<br />Built by Bill Kowalski of <a href="https://mahonebaywebdesign.com">Mahone Bay Web Design</a>.<br />This website is best viewed in Chrome or Edge on larger screens.<br /><br />Current image: ${collectionID}<br /> Current collection page ${pageNum} <br /><br />To see a new image, refresh the page or click the button below.<br /><p style="margin-top: 1rem; text-align: center; font-weight: bold;">CAUTION: Some images may be unsafe for work (NSFW) or inappropriate for minors.</p>`;
